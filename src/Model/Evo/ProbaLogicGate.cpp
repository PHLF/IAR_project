...
ProbabilisticLogicGate::ProbabilisticLogicGate(std::vector<uint32_t>&& input_nodes_ids,
                                               std::vector<uint32_t>&& output_nodes_ids,
                                               std::vector<uint8_t>&&  table)
    : _input_nodes_ids(std::move(input_nodes_ids)), _output_nodes_ids(std::move(output_nodes_ids)),
